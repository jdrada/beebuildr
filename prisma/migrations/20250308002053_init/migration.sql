-- CreateEnum
CREATE TYPE "OrganizationType" AS ENUM ('CONTRACTOR', 'STORE');
...
-- AddForeignKey
ALTER TABLE "BudgetItem" ADD CONSTRAINT "BudgetItem_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
